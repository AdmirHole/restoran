...
try{
        ...
        if(isset($_POST['app_name'])){
                ...
                $check_app = new User();
                        if($check_app->check_apps($_POST['app_name']) == true){
                                if(isset($_POST['package'])){
                                        ...
                                        header('location: https://admin.lab387.com/verifynumber-twitter?app='.$app.'&package='.$package);
                                }else{
                                        header('location: https://admin.lab387.com/verifynumber-twitter?app='.$app);
                                }
                        }else{
                                header('location: https://admin.lab387.com/verifynumber-twitter');
                        }
        }else{
                header('location: https://admin.lab387.com/verifynumber-twitter');
        }
                ...
                if(isset($_POST['package'])){
                        $package = $_POST['package'];
                        header('location: https://admin.lab387.com/error?error=18&app='.$app.'&package='.$package);
                }else{
                        header('location: https://admin.lab387.com/error?error=18&app='.$app);
                }
                }else{
                header('location: https://admin.lab387.com/error?error=18');
                }
}