                ...
                $check_app = new User();
                        if($check_app->check_apps($_POST['app_name']) == true){
                                if(isset($_POST['package'])){
                                        ...
                                        header('location: https://admin.lab387.com/verifynumber-google?app='.$app.'&package='.$package);
                                }else{
                                        header('location: https://admin.lab387.com/verifynumber-google?app='.$app);
                                }
                        }else{
                                header('location: https://admin.lab387.com/verifynumber-google');
                        }
        }else{
                header('location: https://admin.lab387.com/verifynumber-google');
        }
