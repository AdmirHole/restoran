...
try{
                ...
                $check_app = new User();
                        if($check_app->check_apps($_POST['app_name']) == true){
                                if(isset($_POST['package'])){
                                        ...
                                        header('location: https://admin.lab387.com/verifynumber-linkedin?app='.$app.'&package='.$package);
                                }else{
                                        header('location: https://admin.lab387.com/verifynumber-linkedin?app='.$app);
                                }
                        }else{
                                header('location: https://admin.lab387.com/verifynumber-linkedin');
                        }
        }else{
                header('location: https://admin.lab387.com/verifynumber-linkedin');
        }
        ...
        if(isset($_POST['app_name'])){
                ...
                if(isset($_POST['package'])){
                        $package = $_POST['package'];
                        header('location: https://admin.lab387.com/error?error=16&app='.$app.'&package='.$package);
                }else{
                        header('location: https://admin.lab387.com/error?error=16&app='.$app);
                }
                }else{
                header('location: https://admin.lab387.com/error?error=16');
                }      
}